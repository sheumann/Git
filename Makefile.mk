...
# Generic C compiler
#CC = cc -O2
# Use -O95 or less (no loop invariant removal) for reasonably fast compilation
OPTIONS = -i -O79 -Sgit_______
...
version.h: Makefile
	/bin/echo "// Automatically generated file -- do not edit!" > version.h
	/bin/echo \"#define GIT_MAJOR\" $(MAJOR) >> version.h
	/bin/echo \"#define GIT_MINOR\" $(MINOR) >> version.h
	/bin/echo \"#define GIT_PATCH\" $(PATCH) >> version.h
	chtyp -l cc version.h
